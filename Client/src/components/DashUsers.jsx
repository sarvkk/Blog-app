            ...
            {currentUser.isAdmin && users.length > 0 ? (
                ...
                <Table hoverable className="shadow-md">
                    ...
                    {users && users.map((user1) => (
                        <Table.Body className="divide-y" key={user1._id}>
                            <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
                                <Table.Cell>{new Date(user1.createdAt).toLocaleDateString()}</Table.Cell>
                                <Table.Cell>
                                ...
                                <Table.Cell>
                                  {user1.isAdmin ?(<FaCheck className="text-green-500"/>):(<FaTimes className="text-red-500"/>)}
                                </Table.Cell>
                                <Table.Cell>
                                    <span onClick={()=>{
                                        setShowModal(true);
